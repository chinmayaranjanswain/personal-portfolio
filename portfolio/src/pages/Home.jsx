    ...
    <>
      ...
      <section className="gallery-section">
        ...
        <div className="gallery-grid">
          {[
            { src: '/assets/photos/replace the music pic.webp', alt: 'Code & Coffee', caption: 'nature', color: '#6366f1' },
            { src: '/assets/photos/replace the neture pic.png', alt: 'Late Night Builds', caption: 'Late Night travels', color: '#ec4899' },
            { src: '/assets/photos/retouch_2025010110364641.webp', alt: 'Hackathon Vibes', caption: 'enjoyy Vibes', color: '#14b8a6' },
            { src: '/assets/photos/retouch_2024113010444844.webp', alt: 'Design Process', caption: 'counting stars', color: '#f59e0b' },
            { src: '/assets/photos/retouch_2024122017045988.webp', alt: 'Team Work', caption: 'rivers', color: '#8b5cf6' },
            { src: '/assets/photos/retouch_2024112713071997.webp', alt: 'Open Source', caption: 'Open Source', color: '#10b981' },
          ].map((item, i) => (
